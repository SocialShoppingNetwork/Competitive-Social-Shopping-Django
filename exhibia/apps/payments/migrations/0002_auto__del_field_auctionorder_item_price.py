...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'AuctionOrder.item_price'
        db.delete_column('payments_auctionorder', 'item_price')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'AuctionOrder.item_price'
        raise RuntimeError("Cannot reverse this migration. 'AuctionOrder.item_price' and its values cannot be restored.")
