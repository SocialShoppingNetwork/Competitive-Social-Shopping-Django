...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PaymentNotification.shipping'
        db.alter_column('payments_paymentnotification', 'shipping', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2))

        # Changing field 'PaymentNotification.mc_gross'
        db.alter_column('payments_paymentnotification', 'mc_gross', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2))

        # Changing field 'CreditPackageOrder.amount_paid'
        db.alter_column('payments_creditpackageorder', 'amount_paid', self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=2))

        # Changing field 'AuctionOrder.amount_paid'
        db.alter_column('payments_auctionorder', 'amount_paid', self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'PaymentNotification.shipping'
        db.alter_column('payments_paymentnotification', 'shipping', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'PaymentNotification.mc_gross'
        db.alter_column('payments_paymentnotification', 'mc_gross', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'CreditPackageOrder.amount_paid'
        db.alter_column('payments_creditpackageorder', 'amount_paid', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'AuctionOrder.amount_paid'
        db.alter_column('payments_auctionorder', 'amount_paid', self.gf('django.db.models.fields.FloatField')())
    ...
    models = {
        ...
        'payments.auctionorder': {
            ...
            'amount_paid': ('django.db.models.fields.DecimalField', [], {'default': "'0'", 'max_digits': '7', 'decimal_places': '2'}),
            ...
            'winner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'auction_order'", 'to': "orm['auth.User']"})
        },
        'payments.card': {
        ...
        'payments.paymentnotification': {
            ...
            'mc_gross': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '7', 'decimal_places': '2', 'blank': 'True'}),
            ...
            'shipping': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '7', 'decimal_places': '2', 'blank': 'True'}),
