...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('payments_paymentnotification', (
            ...
            ('custom1', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('custom2', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
        ...
        db.create_table('payments_creditpackageorder', (
            ...
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auctions.AuctionItem'], null=True, blank=True)),
            ('amount_paid', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('pn', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['payments.PaymentNotification'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        ...
        db.create_table('payments_auctionorder', (
            ...
            ('amount_paid', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('method', self.gf('django.db.models.fields.CharField')(default='p', max_length=3)),
            ('status', self.gf('django.db.models.fields.CharField')(default='n', max_length=3)),
        ...
        db.create_table('payments_card', (
            ...
            ('expiration_month', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
            ('expiration_year', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
            ('deleted', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('payments', ['Card'])
