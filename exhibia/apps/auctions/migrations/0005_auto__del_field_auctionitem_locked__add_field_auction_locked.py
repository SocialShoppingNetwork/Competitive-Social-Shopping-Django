...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AuctionItem.locked'
        db.delete_column('auctions_auctionitem', 'locked')

        # Adding field 'Auction.locked'
        db.add_column('auctions_auction', 'locked',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'AuctionItem.locked'
        db.add_column('auctions_auctionitem', 'locked',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Auction.locked'
        db.delete_column('auctions_auction', 'locked')
