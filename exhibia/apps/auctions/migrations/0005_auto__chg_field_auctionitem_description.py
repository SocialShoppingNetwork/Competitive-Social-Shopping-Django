...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AuctionItem.description'
        db.alter_column('auctions_auctionitem', 'description', self.gf('tinymce.models.HTMLField')())

    def backwards(self, orm):

        # Changing field 'AuctionItem.description'
        db.alter_column('auctions_auctionitem', 'description', self.gf('tinymce.models.HTMLField')(null=True))
