...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AuctionBid.price'
        db.alter_column('auctions_auctionbid', 'price', self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=2))

        # Changing field 'AuctionItem.shipping_fee'
        db.alter_column('auctions_auctionitem', 'shipping_fee', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2))

        # Changing field 'AuctionItem.price'
        db.alter_column('auctions_auctionitem', 'price', self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=2))

        # Changing field 'Auction.current_offer'
        db.alter_column('auctions_auction', 'current_offer', self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=2))

        # Changing field 'AuctionPlegde.amount'
        db.alter_column('auctions_auctionplegde', 'amount', self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'AuctionBid.price'
        db.alter_column('auctions_auctionbid', 'price', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'AuctionItem.shipping_fee'
        db.alter_column('auctions_auctionitem', 'shipping_fee', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'AuctionItem.price'
        db.alter_column('auctions_auctionitem', 'price', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Auction.current_offer'
        db.alter_column('auctions_auction', 'current_offer', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'AuctionPlegde.amount'
        db.alter_column('auctions_auctionplegde', 'amount', self.gf('django.db.models.fields.PositiveIntegerField')())
