...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Member.points_amount'
        db.add_column('profiles_member', 'points_amount',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Member.points_amount'
        db.delete_column('profiles_member', 'points_amount')
    ...
    models = {
        ...
        'profiles.billingaddress': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'billing_addresses'", 'to': "orm['auth.User']"}),
