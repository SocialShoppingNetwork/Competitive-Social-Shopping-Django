...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Adding field 'BillingAddress.shipping'
        db.add_column('profiles_billingaddress', 'shipping',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['shipping.ShippingAddress'], unique=True, null=True, blank=True),
                      keep_default=False)
