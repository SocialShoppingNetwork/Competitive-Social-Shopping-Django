...
class MemberInfoFormCA(forms.Form):
    first_name = forms.CharField(max_length=60)
    last_name = forms.CharField(max_length=60)
    address1 = forms.CharField(max_length=200)
    address2 = forms.CharField(max_length=200, required=False)
    ...
    zip_code = forms_ca.CAPostalCodeField(help_text='format XXX XXX')
    state = forms_ca.CAProvinceField(label='Region', widget=forms_ca.CAProvinceSelect())
    phone = forms_ca.CAPhoneNumberField(help_text='format XXX-XXX-XXXX')

class MemberInfoFormUK(forms.Form):
    first_name = forms.CharField(max_length=60)
    last_name = forms.CharField(max_length=60)
    address1 = forms.CharField(max_length=200)
    address2 = forms.CharField(max_length=200, required=False)
    city = forms.CharField(label='Town/City', max_length=60)

    zip_code = forms_uk.UKPostcodeField(label='Postal code')
    state = forms_uk.CharField(label='County', max_length=50)
    phone = forms.CharField(max_length=50)
