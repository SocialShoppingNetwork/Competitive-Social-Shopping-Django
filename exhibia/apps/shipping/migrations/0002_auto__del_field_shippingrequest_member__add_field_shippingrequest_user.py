...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ShippingRequest.member'
        db.delete_column('shipping_shippingrequest', 'member_id')
        ...
        db.create_unique('shipping_shippingrequest', ['auction_id', 'user_id'])

        # Deleting field 'ShippingAddress.member'
        db.delete_column('shipping_shippingaddress', 'member_id')
    ...
    def backwards(self, orm):
        # Removing unique constraint on 'ShippingRequest', fields ['auction', 'user']
        db.delete_unique('shipping_shippingrequest', ['auction_id', 'user_id'])


        # User chose to not deal with backwards NULL issues for 'ShippingRequest.member'
        raise RuntimeError("Cannot reverse this migration. 'ShippingRequest.member' and its values cannot be restored.")
        # Deleting field 'ShippingRequest.user'
        db.delete_column('shipping_shippingrequest', 'user_id')
        ...
        # User chose to not deal with backwards NULL issues for 'ShippingAddress.member'
        raise RuntimeError("Cannot reverse this migration. 'ShippingAddress.member' and its values cannot be restored.")
        # Deleting field 'ShippingAddress.user'
        db.delete_column('shipping_shippingaddress', 'user_id')
