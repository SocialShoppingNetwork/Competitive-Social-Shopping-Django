...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Brand.slug'
        db.alter_column('auctions_brand', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=250))
        # Adding index on 'Brand', fields ['slug']
        db.create_index('auctions_brand', ['slug'])


        # Changing field 'Category.slug'
        db.alter_column('auctions_category', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=250))
        # Adding index on 'Category', fields ['slug']
        db.create_index('auctions_category', ['slug'])


    def backwards(self, orm):
        # Removing index on 'Category', fields ['slug']
        db.delete_index('auctions_category', ['slug'])

        # Removing index on 'Brand', fields ['slug']
        db.delete_index('auctions_brand', ['slug'])


        # Changing field 'Brand.slug'
        db.alter_column('auctions_brand', 'slug', self.gf('django.db.models.fields.CharField')(max_length=250, unique=True))

        # Changing field 'Category.slug'
        db.alter_column('auctions_category', 'slug', self.gf('django.db.models.fields.CharField')(max_length=250, unique=True))
