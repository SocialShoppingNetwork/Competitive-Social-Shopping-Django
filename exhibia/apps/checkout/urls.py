...
from profiles.views import manage_addresses
...
urlpatterns += patterns('',
    ...
    url(r"^review/(?P<auction_pk>\d+?)/(?P<shipping_pk>\d+?)/(?P<billing_pk>\d+?)/(?P<card_pk>\d+?)/$", "checkout.views.review_order", name="checkout_review"),
)
