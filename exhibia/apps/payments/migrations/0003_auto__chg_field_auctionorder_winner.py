...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AuctionOrder.winner'
        db.alter_column('payments_auctionorder', 'winner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'AuctionOrder.winner'
        db.alter_column('payments_auctionorder', 'winner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profiles.Member']))
