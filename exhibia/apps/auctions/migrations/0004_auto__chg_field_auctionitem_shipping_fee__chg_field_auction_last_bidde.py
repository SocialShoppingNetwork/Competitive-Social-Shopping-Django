...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('auctions_auctionitem', 'shipping_fee', self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=2))

        # Changing field 'Auction.last_bidder_member'
        db.alter_column('auctions_auction', 'last_bidder_member_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Auction.last_bidder_member'
        db.alter_column('auctions_auction', 'last_bidder_member_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['profiles.Member']))
