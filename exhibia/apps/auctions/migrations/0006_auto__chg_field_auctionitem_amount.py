...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AuctionItem.amount'
        db.alter_column('auctions_auctionitem', 'amount', self.gf('django.db.models.fields.SmallIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'AuctionItem.amount'
        db.alter_column('auctions_auctionitem', 'amount', self.gf('django.db.models.fields.SmallIntegerField')(default=None))
    ...
    models = {
        ...
        'auctions.auctionitem': {
            ...
            'amount': ('django.db.models.fields.SmallIntegerField', [], {'null': 'True'}),
