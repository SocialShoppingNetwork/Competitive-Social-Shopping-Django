...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BillingAddress.member'
        db.alter_column('profiles_billingaddress', 'member_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
        # Deleting field 'Member.name'
        db.delete_column('profiles_member', 'name')


        # Changing field 'Member.user'
        db.alter_column('profiles_member', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['auth.User']))
        # Adding unique constraint on 'Member', fields ['user']
        db.create_unique('profiles_member', ['user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Member', fields ['user']
        db.delete_unique('profiles_member', ['user_id'])


        # Changing field 'BillingAddress.member'
        db.alter_column('profiles_billingaddress', 'member_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profiles.Member']))
        # Adding field 'Member.name'
        db.add_column('profiles_member', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Member.user'
        db.alter_column('profiles_member', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
    ...
    models = {
        ...
        'profiles.billingaddress': {
            ...
            'member': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'billing_addesses'", 'to': "orm['auth.User']"}),
