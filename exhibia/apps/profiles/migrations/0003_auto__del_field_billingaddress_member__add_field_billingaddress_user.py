...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BillingAddress.member'
        db.rename_column('profiles_billingaddress', 'member_id', 'user_id')
        # db.delete_column('profiles_billingaddress', 'member_id')

        # # Adding field 'BillingAddress.user'
        # db.add_column('profiles_billingaddress', 'user',
        #               self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='billing_addesses', to=orm['auth.User']),
        #               keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'BillingAddress.member'
        raise RuntimeError("Cannot reverse this migration. 'BillingAddress.member' and its values cannot be restored.")
        # Deleting field 'BillingAddress.user'
        db.delete_column('profiles_billingaddress', 'user_id')
