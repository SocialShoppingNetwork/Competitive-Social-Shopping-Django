...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'IPAddress.created_at'
        db.delete_column('profiles_ipaddress', 'created_at')

        # Adding field 'IPAddress.last_login'
        db.add_column('profiles_ipaddress', 'last_login',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'IPAddress.created_at'
        raise RuntimeError("Cannot reverse this migration. 'IPAddress.created_at' and its values cannot be restored.")
        # Deleting field 'IPAddress.last_login'
        db.delete_column('profiles_ipaddress', 'last_login')
    ...
    models = {
        ...
        'profiles.ipaddress': {
            ...
            'Meta': {'ordering': "('-last_login',)", 'unique_together': "(('user', 'IPAddress'),)", 'object_name': 'IPAddress'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
