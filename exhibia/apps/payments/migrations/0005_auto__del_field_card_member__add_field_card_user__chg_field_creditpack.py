...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Card.member'
        db.delete_column('payments_card', 'member_id')

        # Adding field 'Card.user'
        db.add_column('payments_card', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)


        # Changing field 'CreditPackageOrder.buyer'
        db.alter_column('payments_creditpackageorder', 'buyer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Card.member'
        raise RuntimeError("Cannot reverse this migration. 'Card.member' and its values cannot be restored.")
        # Deleting field 'Card.user'
        db.delete_column('payments_card', 'user_id')


        # Changing field 'CreditPackageOrder.buyer'
        db.alter_column('payments_creditpackageorder', 'buyer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profiles.Member']))
    ...
    models = {
        ...
        'payments.creditpackageorder': {
            ...
            'amount_paid': ('django.db.models.fields.DecimalField', [], {'default': "'0'", 'max_digits': '7', 'decimal_places': '2'}),
            'buyer': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'orders'", 'to': "orm['auth.User']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
