...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AuctionItem.giveaway'
        db.add_column('auctions_auctionitem', 'giveaway',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AuctionItem.giveaway'
        db.delete_column('auctions_auctionitem', 'giveaway')
