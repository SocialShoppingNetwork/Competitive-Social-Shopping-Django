...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AuctionItem.lock_after'
        db.add_column('auctions_auctionitem', 'lock_after',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AuctionItem.lock_after'
        db.delete_column('auctions_auctionitem', 'lock_after')
    ...
    models = {
        ...
        'auctions.auctionitem': {
            ...
            'lock_after': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
